...
Ext.onReady(function() {
	...
	var deptTree = new Ext.tree.TreePanel({
				loader : new Ext.tree.TreeLoader({
							baseAttrs : {},
							dataUrl : _ctxpath + '/rolePart/departmentTreeInit.do'
						}),
				root : root,
				title : '',
				applyTo : 'deptTreeDiv',
	...
	var store_part = new Ext.data.Store({
				...
				proxy : new Ext.data.HttpProxy({
							url : _ctxpath + '/rolePart/queryParts.do'
						}),
				reader : new Ext.data.JsonReader({
							totalProperty : 'TOTALCOUNT',
							root : 'ROOT'
	...
	var menuTreePanel = new Ext.tree.TreePanel({
				loader : new Ext.tree.TreeLoader({
							baseAttrs : {},
							dataUrl : _ctxpath + '/part/queryMenuItems.do'
						}),
				root : root,
	...
	function saveData() {
		...
		Ext.Ajax.request({
					url : _ctxpath + '/rolePart/savePartUserGrantDatas.do',
