...
Ext.onReady(function() {
	...
	var deptTree = new Ext.tree.TreePanel({
				loader : new Ext.tree.TreeLoader({
							baseAttrs : {},
							dataUrl : _ctxpath + '/user/departmentTreeInit.do'
						}),
				root : root,
				title : '',
				applyTo : 'deptTreeDiv',
	...
	var store = new Ext.data.Store({
				proxy : new Ext.data.HttpProxy({
							url : _ctxpath + '/user/queryUsersForManage.do'
						}),
	...
	function saveUserItem() {
		...
		addUserFormPanel.form.submit({
					url : _ctxpath + '/user/saveUserItem.do',
					waitTitle : '提示',
					method : 'POST',
					waitMsg : '正在处理数据,请稍候...',
				...
				.confirm(
						...
						function(btn, text) {
							if (btn == 'yes') {
								...
								showWaitMsg();
								Ext.Ajax.request({
									url : _ctxpath + '/user/deleteUserItems.do',
	...
	function update() {
		addUserFormPanel.form.submit({
					url : _ctxpath + '/user/updateUserItem.do',
					waitTitle : '提示',
					method : 'POST',
					waitMsg : '正在处理数据,请稍候...',
					success : function(form, action) {
	...
	function userGrantInit(userid, deptid, usertype) {
		...
		var selectRoleTab = new Ext.Panel({
			title : '<img src="' + _ctxpath + '/resource/image/ext/award_star_silver_3.png" align="top" class="IEPNG"> 选择角色',
			// iconCls: 'user_femaleIcon',
			autoLoad : {
				url : _ctxpath + '/user/userGrantInit.do',
				scripts : true,
		...
		var selectMenuTab = new Ext.Panel({
			title : '<img src="' + _ctxpath + '/resource/image/ext/config.png" align="top" class="IEPNG"> 选择菜单',
			// iconCls: 'user_femaleIcon',
			autoLoad : {
				url : _ctxpath + '/user/selectMenuInit.do',
				scripts : true,
				text : parent.PAGE_LOAD_MSG,
				params : {
					userid : userid,
