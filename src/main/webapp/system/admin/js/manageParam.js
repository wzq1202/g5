...
Ext.onReady(function() {
	...
	var store = new Ext.data.Store({
				proxy : new Ext.data.HttpProxy({
							url : _ctxpath + '/param/queryParamsForManage.do'
						}),
	...
	function saveParamItem() {
		...
		addParamFormPanel.form.submit({
					url : _ctxpath + '/param/saveParamItem.do',
					waitTitle : '提示',
					method : 'POST',
					waitMsg : '正在处理数据,请稍候...',
	...
	function synMemory(msg, flag) {
		Ext.Msg.confirm('请确认', msg, function(btn, text) {
					if (btn == 'yes') {
						showWaitMsg();
						Ext.Ajax.request({
									url : _ctxpath + '/param/synMemory.do',
	...
	function deleteParamItems() {
		...
		Ext.Msg.confirm('请确认', '确认删除选中的全局参数吗?', function(btn, text) {
					if (btn == 'yes') {
						...
						showWaitMsg();
						Ext.Ajax.request({
									url : _ctxpath + '/param/deleteParamItems.do',
									success : function(response) {
	...
	function update() {
		addParamFormPanel.form.submit({
					url : _ctxpath + '/param/updateParamItem.do',
					waitTitle : '提示',
					method : 'POST',
					waitMsg : '正在处理数据,请稍候...',
					success : function(form, action) {
