...
Ext.onReady(function() {
	...
	var deptTree = new Ext.tree.TreePanel( {
		loader : new Ext.tree.TreeLoader( {
			baseAttrs : {},
			dataUrl : _ctxpath + '/organization/departmentTreeInit.do'
		}),
		root : root,
		title : '',
		applyTo : 'deptTreeDiv',
	...
	var store = new Ext.data.Store( {
		proxy : new Ext.data.HttpProxy( {
			url : _ctxpath + '/organization/queryDeptsForManage.do'
		}),
	...
	// 翻页排序时带上查询条件
		...
		function saveDeptItem() {
			...
			addDeptFormPanel.form.submit( {
				url : _ctxpath + '/organization/saveDeptItem.do',
				waitTitle : '提示',
				method : 'POST',
				waitMsg : '正在处理数据,请稍候...',
		...
		function update() {
			...
			addDeptFormPanel.form.submit( {
				url : _ctxpath + '/organization/updateDeptItem.do',
				waitTitle : '提示',
				method : 'POST',
				waitMsg : '正在处理数据,请稍候...',
				success : function(form, action) {
					...
					.confirm(
							...
							function(btn, text) {
								if (btn == 'yes') {
									...
									Ext.Ajax
											.request( {
												url : _ctxpath + '/organization/deleteDeptItems.do',
