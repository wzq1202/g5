    <%@page import="org.g4studio.core.util.G4Utils"%>
<%@page import="javax.annotation.Resource"%>
<%@page import="org.g4studio.data.service.SetParamService"%>
<%@ page language="java" contentType="text/html; charset=utf-8"
        ...
        <%@ page import="org.g4studio.core.web.util.Uploader" %>
...
up.setSavePath( dir );
//up.setAbsolutePrefix(setParamService.queryByKey("PIC_PATH"))
