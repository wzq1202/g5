...
public class WebUtils {
	 ...
	 * @return
	 */
	public static Dto getParamAndUserAsDto(HttpServletRequest request) {
		Dto dto = new BaseDto();
		Map map = request.getParameterMap();
		Iterator keyIterator = (Iterator) map.keySet().iterator();
		while (keyIterator.hasNext()) {
		...
		dto.put("userId", userInfoVo.getUserid());
		dto.put("userName", userInfoVo.getUsername());
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		dto.put("createtime", sdf.format(new Date()));
		return dto;
	}
	 ...
	 * @return
	 */
	public static List getGridDirtyData(HttpServletRequest request){
